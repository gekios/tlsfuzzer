...
def help_msg():
    ...
    print(" -b             if present, test expect that server will sign the")
    print("                the Certificate Verify message for rsa_ssa")
    print("                encryption, otherwise expect handshake failure")
...
def main():
    ...
    print("For rsassa-pss certificate, present '-b' argument.\n")
    print("version: {0}\n".format(version))
